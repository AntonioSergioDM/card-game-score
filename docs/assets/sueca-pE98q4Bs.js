import"./theme-DGZ6EVSB.js";import{$ as d,c as a}from"./common-7JqXXPz4.js";const N=(function(){let p,h,$,m=!1,S=!1,P=!1,u=10;const g=20;let f=[];const B=()=>{a.init(),p=d("#newScore"),h=d("#inputHolder"),$=d("#undoBtn"),H()},H=()=>{setInterval(w,100),p.on("click",T),h.on("click",T),$.on("click",C),d("#restartBtn").on("click",x),d("#startNormalScore").on("click",()=>k("normal")),d("#startUnlimitedScore").on("click",I)},I=()=>{p.html(`
